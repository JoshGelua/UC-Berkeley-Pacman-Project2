                ...
                if cell:  # There's a wall here
                    ...
                    if (nIsWall) and (not wIsWall):
                        ...
                        line(
                            ...
                            add(
                                screen,
                                (self.gridSize * (-1) * WALL_RADIUS, self.gridSize * (-0.5) - 1),
                            ),
                            wallColor,
                        )
                    ...
                    if (nIsWall) and (wIsWall) and (not nwIsWall):
                        ...
                        line(
                            ...
                            add(
                                screen, (self.gridSize * (-0.5), self.gridSize * (-1) * WALL_RADIUS)
                            ),
                            wallColor,
                        )
                        line(
                            ...
                            add(
                                screen, (self.gridSize * (-1) * WALL_RADIUS, self.gridSize * (-0.5))
                            ),
                            wallColor,
                        )
                    ...
                    if (not sIsWall) and (eIsWall):
                        ...
                        line(
                            add(screen, (0, self.gridSize * (1) * WALL_RADIUS)),
                            add(
                                screen, (self.gridSize * 0.5 + 1, self.gridSize * (1) * WALL_RADIUS)
                            ),
                            wallColor,
                        )
